...
This project is indexed by GitNexus as **marvin** (5810 symbols, 13721 relationships, 280 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/marvin/context` | Codebase overview, check index freshness |
| `gitnexus://repo/marvin/clusters` | All functional areas |
| `gitnexus://repo/marvin/processes` | All execution flows |
| `gitnexus://repo/marvin/process/{name}` | Step-by-step execution trace |
